...
uas = 'Mozilla/5.0 (Linux; Android 10; Redmi Note 8 Pro Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.77 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/322.0.0.35.121;]'
ips=None
try:
...
anton = str(datetime.now().strftime('%X'))
kota = requests.get("http://yayanxd.herokuapp.com/kota").text
def tak():
    tatak = [
     '.   ', '..  ', '... ']
    for o in tatak:
...
def dewa():
    ...
    time.sleep(0.07)
    print'\x1b[0;35m• \x1b[0;31mKey Belum Di konfirmasi\x1b[1;39m'
    print'\x1b[0;35m• \x1b[0;36mChat Admin Untuk Mengkonfirmasi Key\x1b[0;39m'
    time.sleep(0.07)
...
def user1():
    try:
        ...
        r = requests.get('https://pastebin.com/u/Antonibrahim?guest=1').text.strip() # Jangan Di ganti bro'i nanti error
        if j in r:
            os.system('clear')
            print logo
            print logo2
...
def menu():
    ...
    print"[+] Email     : "
    print"\033[1;97m[+] ----------------------------------------"
    print"[+] Beragbung : 4 Juli 2021"
    print"[+] Kadaluwasa: 30 Juli 2021"
    print"\033[1;97m[+] ----------------------------------------"
    print"[+] IP Anda   : "  +ip
    print"[+] Kota      : "  +kota
    print"[+] Negara    : "  +ips
...
def menubapi():
    ...
    print"[+] Welcome   : \033[0;93m"+nama+"\033[0;97m"
    print"\033[1;97m[+] ----------------------------------------"
    print"[+] Setatus   : \033[0;92mPremium\033[0;97m"
    print"[+] Your IP   : "  +ip
    print"[+] Kota      : "  +kota
    print"[+] Negara    : "  +ips
...
def pilih_menubapi():
    ...
    print'[+] File \x1b[0;93mOK\x1b[0;97m Tersimpan Di:out/CP-%s-%s-%s.txt' % (ha, op, ta)
